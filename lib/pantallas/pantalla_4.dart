...
class _pantalla_4State extends State<pantalla_4> {
  ...
  void getNegocios() async {
    ...
    QuerySnapshot productos =
        await datos.where("descripcion", isEqualTo: widget.negocios).get();
...
class datosTienda {
  ...
  datosTienda(Categoria, Celular, Direccion, Foto, Geolocalizacion, Nombre,
      PaginaWeb, Telefono) {
